========================================================================
    KONSOLENANWENDUNG: 4 Gewinnt-Projektübersicht
========================================================================

Diese 4 Gewinnt-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 4 Gewinnt-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 4 Gewinnt.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
